...
const isBuilt = fs.existsSync(joinPath(pathArcJsRoot, "dist"));
/**
 ...
 */
const migrationBuildCommand =
  (runningAsInstalledPackage && !packagesAreInstalled) ? "npm install" : isBuilt ? "" : "nps build";
