...
import { getValueFromLogs, requireContract, NULL_ADDRESS } from "./utils.js";
...
export class Organization {
  ...
  static async at(avatarAddress) {
    ...
    if (contracts.defaultVotingMachine) {
      org.votingMachine = AbsoluteVote.at(contracts.defaultVotingMachine.address);
    }
  ...
  /**
   * returns schemes currently in this DAO as Array<OrganizationSchemeInfo>
   */
  async _getSchemes() {
