...
import { daostackSettings } from './settings.js';
...
export function getWeb3() {
  ...
  if (typeof window !== "undefined" && typeof window.web3 !== "undefined") {
    ...
    preWeb3 = new Web3(new Web3.providers.HttpProvider(daostackSettings.providerUrl));
  }
...
export function getDefaultAccount() {
  const web3 = getWeb3();
  const defaultAccount = web3.eth.defaultAccount = web3.eth.defaultAccount || web3.eth.accounts[0];
