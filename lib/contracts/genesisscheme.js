...
export class GenesisScheme extends ExtendTruffleContract(SolidityContract) {
  ...
  async forgeOrg(opts = {}) {
    /**
       * See these properties in DaoConfig
     */
    const defaults = {
      name: undefined,
      tokenName: undefined,
    ...
    const controllerAddress = options.universalController ? (await (await Utils.requireContract("UController")).deployed()).address : Utils.NULL_ADDRESS;
