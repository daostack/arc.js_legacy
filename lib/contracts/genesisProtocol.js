...
export class GenesisProtocol extends ExtendTruffleContract(SolidityContract) {
  ...
  async getRedeemProposerReputation(opts = {}) {
  ...
  async getRedeemVoterAmount(opts = {}) {
  ...
  async getRedeemVoterReputation(opts = {}) {
  ...
  async getRedeemStakerRepAmount(opts = {}) {
