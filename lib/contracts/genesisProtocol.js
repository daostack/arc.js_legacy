...
export class GenesisProtocol extends ExtendTruffleContract(SolidityContract) {
  ...
  /**
   * Returns the current number of each vote, including abstain.  The first item is abstain.
   * @param {GetVotesStatusConfig} opts
   * @returns Array<Promise<BigNumber.BigNumber>>
   */
