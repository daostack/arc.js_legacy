...
import { SHA3, getDefaultAccount, ExtendTruffleContract, requireContract, getWeb3 } from './utils.js';

const SolidityContributionReward = requireContract("ContributionReward");
const DAOToken = requireContract("DAOToken");

class ContributionReward extends ExtendTruffleContract(SolidityContributionReward) {
  ...
  static async new(opts={}) {
    ...
    const contract = await SolidityContributionReward.new(token.address, options.fee, options.beneficiary);
