...
import { AbsoluteVote } from "./contracts/absoluteVote";
...
export class DAO {
  ...
  static async new(opts) {
    ...
    const defaultVoteParametersHash = (await dao.votingMachine.setParams({
    ...
    for (const schemeOptions of options.schemes) {
      ...
      if (schemeOptions.votingMachineParams && (schemeOptions.votingMachineParams != {})) {
        ...
        schemeVoteParametersHash = (await dao.votingMachine.setParams({
