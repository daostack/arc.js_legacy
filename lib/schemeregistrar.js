...
export class SchemeRegistrar extends ExtendTruffleContract(SoliditySchemeRegistrar) {
  static async new(opts={}) {
    ...
    const contract = await SoliditySchemeRegistrar.new(token.address, options.fee, options.beneficiary);
  ...
  async proposeToRemoveScheme(opts={}) {
    ...
    const tx = await this.contract.proposeToRemoveScheme(options.avatar, options.scheme);
