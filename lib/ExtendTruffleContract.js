...
export const ExtendTruffleContract = superclass =>
  class {
     ...
     *
     * @param {...any} args -- object with properties whose names are expected by the scheme to correspond to parameters.
...
export class ArcTransactionResult {
   ...
   */
  getValueFromTx(valueName, eventName = null, index = 0) {
