import { nconf as config } from './config.js';
...
export class Wallet {
  ...
  async sendOrgTokens(organizationAvatarAddress, toAccountAddress, numTokens) {
    ...
    const transactionData = org.token.transfer.request(toAccountAddress, numTokens, { from: this.getPublicAddress() }).params[0].data;
